export const LEGAL = {
  privacy: {
    ...
    intro: "Your privacy is critically important to us.",
    sections: [
      {
        title: "Overview",
        content: [
      ...
      },
      {
        ...
        content: [
          "Ads appearing on our website may be delivered to users by advertising partners, who may set cookies. These cookies allow the ad server to recognize your computer each time they send you an online advertisement to compile information about you or others who use your computer. This information allows ad networks to, among other things, deliver targeted advertisements that they believe will be of most interest to you. This Privacy Policy covers the use of cookies by GitView LLC and does not cover the use of cookies by any advertisers.",
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          "GitView LLC may collect statistics about the behavior of visitors to its website. GitView LLC may display this information publicly or provide it to others. However, GitView LLC does not disclose your personally-identifying information.",
        ],
      },
      {
      ...
      },
      {
        title: "E-commerce",
        content: [
          "Those who engage in transactions with GitView LLC – by purchasing GitView LLC’s services or products, are asked to provide additional information, including as necessary the personal and financial information required to process those transactions. In each case, GitView LLC collects such information only insofar as is necessary or appropriate to fulfill the purpose of the visitor’s interaction with GitView LLC. GitView LLC does not disclose personally-identifying information other than as described below. And visitors can always refuse to supply personally-identifying information, with the caveat that it may prevent them from engaging in certain website-related activities.",
        ],
      },
      {
        title: "Privacy Policy Changes",
        content: [
          "Although most changes are likely to be minor, GitView LLC may change its Privacy Policy from time to time, and in GitView LLC’s sole discretion. GitView LLC encourages visitors to frequently check this page for any changes to its Privacy Policy. Your continued use of this site after any change in this Privacy Policy will constitute your acceptance of such change.",
        ],
      },
      {
        title: "Contact Information",
        content: [
          "If you have any questions about this Privacy Policy, please contact us via email at support@gitview.com.",
        ],
      },
    ],
  },
  terms: {
    ...
    sections: [
      {
        title: "Welcome to GitView, LLC",
        content: [
          "These terms and conditions outline the rules and regulations for the use of GitView, LLC’s Website.",
          "GitView, LLC is located in Chicago, IL.",
          "By accessing this website we assume you accept these terms and conditions in full. Do not continue to use GitView, LLC’s website if you do not accept all of the terms and conditions stated on this page.",
        ],
      },
      {
        title: "Cookies",
        content: [
          "We employ the use of cookies. By using GitView, LLC’s website you consent to the use of cookies in accordance with GitView, LLC’s privacy policy.",
      ...
      },
      {
        ...
        content: [
          "You give GitView approval to use your service marks or logos on its website, customer lists, and other marketing materials.",
        ],
      },
      {
        title: "Credit & Contact Information",
        content: [
          "If you have any queries regarding any of our terms, please contact us via support@gitview.com.",
        ],
      },
    ],
  },
